...
tf.app.flags.DEFINE_string(
    ...
    'remotely.')
tf.app.flags.DEFINE_string(
    'log_root', '/home/kelvin/OgataLab/magenta/magenta/models/sketch_rnn/layer_norm_1000/trained_data9',
...
# to run with different paramenters eg:
# python sketch_rnn_train.py --data_dir=sketchy_data/ --hparams="data_set=[sketchy_airplane_ep2.npz],num_steps=1000,dec_rnn_size=30,enc_rnn_size=30,z_size=10,batch_size=1"
