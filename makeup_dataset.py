...
def convert_svgs(svg_dir, npz_filename, max_length=168, num_train=100, num_valid=1):
    ...
    svg_filenames = sorted(svg_filenames, key=lambda x: int(re.search(r'(?<=_)\w+', x).group()))
    # ipdb.set_trace()
